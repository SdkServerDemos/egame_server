...
import egame.openapi.cipher.HmacSignature;
import egame.openapi.httpclient.HttpClientUtil;
...
public class RequestParasUtil {
    ...
    public static String sendPostRequest(String reqURL, Map<String, String> requestData) throws Exception {

        String resultStr = "";
        resultStr = HttpClientUtil.doPost(reqURL, requestData);
